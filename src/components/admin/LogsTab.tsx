...
const ACTION_COLORS: Record<string, string> = {
  ...
  cerimonia_criado: 'bg-primary/12 dark:bg-primary/20 text-primary dark:text-primary',
  cerimonia_atualizado: 'bg-primary/12 dark:bg-primary/20 text-primary dark:text-primary',
  ...
  produto_criado: 'bg-primary text-primary dark:bg-primary/30 dark:text-primary',
  produto_atualizado: 'bg-primary text-primary dark:bg-primary/30 dark:text-primary',
